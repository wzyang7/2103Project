...
public class EmployeeEntity implements Serializable {
    ...
    public EmployeeEntity(String firstName, String lastName, AccessRightEnum accessRightEnum, String username, String password) 
    {
        this();
    ...
    public String toString() {
        return "entity.EmployeeEntity[ employeeId=" + employeeId + " ]";
    }
